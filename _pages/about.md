...
======
Main papers
*   **K Li**#; H Wang#; L Zhang; Z Ma; W Zhang; M Li; H Li; L Ai. *Simulated-real data mapping: an AE unseen signal generation method for CFRP plate defects.* (submited to journal)
